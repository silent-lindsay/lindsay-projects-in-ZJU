...
def rotate(xy, theta): #rotate around center by angle theta
...
class AudioAnalyzer:
    ...
    def load(self, filename):
        # mf = ar.audio_open(filename)
        # time_series, sample_rate = mf.channels,mf.samplerate
        time_series, sample_rate = librosa.load(filename)  # getting information from the file

        # getting a matrix which contains amplitude values according to frequency and time index
