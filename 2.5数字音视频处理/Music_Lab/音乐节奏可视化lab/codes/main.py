...
for g in tmp_bars:
    ...
    bars.append(gr)
# bars store the rects to draw on the window

pygame.mixer.music.load(filename)
pygame.mixer.music.play(0)

back_color = circle_color
...
while running:
    ...
    # ticks
    t = pygame.time.get_ticks()
    deltaTime = (t - getTicksLastFrame) / 1000.0 #time after last flush
    getTicksLastFrame = t
    timeCount += deltaTime
    ...
    pygame.display.flip()# flush the window
